...
import { videoClient } from './services/video/video.shared'
export type { Video, VideoData, VideoQuery, VideoPatch } from './services/video/video.shared'
...
/**
 * Returns a typed client for the classipe app.
 *
